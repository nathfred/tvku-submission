            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-row bd-highlight">
                        <div class="buttons">
                            <a href="{{ route('create-pdf-archive',['year'=>$target_year]) }}" class="btn btn-success rounded-pill me-1">Export Tabel</a>
                        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @foreach ($years as $year)
                                        <a class="dropdown-item" href="{{ route('adminhrd-archive',['year'=>$year]) }}">{{ $year }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
